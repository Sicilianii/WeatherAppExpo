...
import {WeatherDATA} from "../components/API";
                        ...
                        <View className={'flex items-center justify-start w-full h-full p-5 box-border'}>
                            ...
                            <View className={'mt-10 w-full h-fit bg-slate-700 rounded-2xl p-5'}>
                                <View className={"flex flex-row items-center justify-between mb-4"}>
                                    ...
                                    <Button title={'See more'} className={"border border-slate-300 hover:border-slate-400"} color="#fff" onPress={ () => { router.push('/AirConditions')}}/>
                                </View>
